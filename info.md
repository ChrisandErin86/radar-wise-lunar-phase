...
RadarWise shows current weather, feels-like temperature when available, hourly and daily forecasts, sunrise and sunset, wind, humidity, dew point, UV index, optional AQI/pollen tiles, and optional radar using existing Home Assistant entities.

It supports United States, Canada, Australia, United Kingdom, and global/other dashboard setups. US cards use NOAA quality-controlled precipitation radar with weak gray/blue echoes suppressed by default. Canada uses Environment Canada radar by default. Australia uses native Bureau of Meteorology radar/map tiles by default. UK and global cards use RainViewer global radar by default.
